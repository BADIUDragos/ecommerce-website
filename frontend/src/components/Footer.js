        ...
        <Row>
          ...
          <Col md={3}>
            <ListGroup variant="flush">
              ...
              <ListGroup.Item>
                <i class="fa-solid fa-phone"></i> + 1 (514) 123-4567
              </ListGroup.Item>
              <ListGroup.Item>
              <i class="fa-solid fa-location-dot"></i> Chateauguay, QC, Canada
              </ListGroup.Item>
            </ListGroup>
          </Col>
          ...
          <Col md={3} >
            <ListGroup variant='flush'>
              ...
              <ListGroup.Item action href="https://www.instagram.com/miellerie.annedora/" className="mt-3">
                <i class="fa-brands fa-instagram"></i> miellerie.annedora
              </ListGroup.Item>
              <ListGroup.Item action href="https://www.facebook.com/profile.php?id=100087444407877">
                <i class="fa-brands fa-facebook"></i> Miellerie Annedora
              </ListGroup.Item>
              <ListGroup.Item action href="https://www.tiktok.com/@miellerieannedoraa">
                <i class="fa-brands fa-tiktok"></i> miellerieannedoraa
              </ListGroup.Item>
            </ListGroup>
          </Col>
        </Row>
